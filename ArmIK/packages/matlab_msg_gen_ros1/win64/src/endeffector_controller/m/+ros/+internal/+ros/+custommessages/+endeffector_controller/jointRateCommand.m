...
%JointRateCommand gives an empty data for endeffector_controller/JointRateCommand
% Copyright 2019-2020 The MathWorks, Inc.
%#codegen
data = struct();
data.MessageType = 'endeffector_controller/JointRateCommand';
...
info.MessageType = 'endeffector_controller/JointRateCommand';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;

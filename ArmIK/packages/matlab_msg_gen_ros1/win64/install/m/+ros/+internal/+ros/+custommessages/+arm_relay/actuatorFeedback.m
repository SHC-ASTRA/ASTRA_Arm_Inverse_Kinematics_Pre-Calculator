...
%ActuatorFeedback gives an empty data for arm_relay/ActuatorFeedback
% Copyright 2019-2020 The MathWorks, Inc.
%#codegen
data = struct();
data.MessageType = 'arm_relay/ActuatorFeedback';
...
info.MessageType = 'arm_relay/ActuatorFeedback';
info.constant = 0;
info.default = 0;
info.maxstrlen = NaN;
info.MaxLen = 1;

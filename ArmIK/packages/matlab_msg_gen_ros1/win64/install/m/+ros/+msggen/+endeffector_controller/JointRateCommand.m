...
classdef JointRateCommand < ros.Message
    %JointRateCommand MATLAB implementation of endeffector_controller/JointRateCommand
    %   This class was automatically generated by
    %   ros.internal.pubsubEmitter.
    %   Copyright 2014-2020 The MathWorks, Inc.
    properties (Constant)
        MessageType = 'endeffector_controller/JointRateCommand' % The ROS message type
    end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        ...
        % Return an empty object array if the structure element is not defined
            if isempty(strObj)
                obj = ros.msggen.endeffector_controller.JointRateCommand.empty(0,1);
                return
            end
            % Create an empty message object
            obj = ros.msggen.endeffector_controller.JointRateCommand(strObj);
        end
    end
end
